...
namespace ClassPractic.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterVM model)
        {
            ...
            string token = await _userManager.GenerateEmailConfirmationTokenAsync(newUser); // Token yaradiram emaile gondermek ucun 
            string link = Url.Action(nameof(ConfirmEmail), "Account", new { userId = newUser.Id, token }, Request.Scheme, Request.Host.ToString()); // User Id . tokeni ve hansi metoda gedecek 
            string subject = "Register Confirmation"; // basliqi 
